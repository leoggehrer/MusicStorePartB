...
Die Erweiterungen der Klasse 'DbMusicStoreContext':

```csharp ({"Type": "FileRef", "File": "Logic/DataContext/Db/DbMusicStoreContextAsync.cs", "StartTag": "//MdStart", "EndTag": "//MdEnd" })
using System;
using System.Linq;
using System.Threading.Tasks;
...
Erweiterung der Klasse 'CsvMusicStoreContext':

```csharp ({"Type": "FileRef", "File": "Logic/DataContext/Csv/CsvMusicStoreContextAsync.cs", "StartTag": "//MdStart", "EndTag": "//MdEnd" })
using System.Threading.Tasks;
...
Erweiterung der Klasse 'SerMusicStoreContext':

```csharp ({"Type": "FileRef", "File": "Logic/DataContext/Ser/SerMusicStoreContextAsync.cs", "StartTag": "//MdStart", "EndTag": "//MdEnd" })
using System.Threading.Tasks;
